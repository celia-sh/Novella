...
public final class NovellaReadiumModule: Module {
  public func definition() -> ModuleDefinition {
    ...
    View(NovellaReadiumView.self) {
      ...
      Events("onReady", "onLocatorChange", "onLink", "onImage", "onError", "onStatus", "onTap", "onBoundary")
      ...
      AsyncFunction("goToProgression") { (view: NovellaReadiumView, progression: Double) async -> Bool in
        await view.goToProgression(progression)
      }
